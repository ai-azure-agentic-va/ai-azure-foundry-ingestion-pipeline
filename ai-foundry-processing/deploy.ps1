# =============================================================================
# AI Foundry Document Ingestion Pipeline — AI Foundry Processing Deployment (Windows)
# =============================================================================
...
# Parse .env into a hashtable. Environment variables override .env values.
$envVars = @{}
Get-Content $EnvFile | ForEach-Object {
    ...
    # Skip keys with dots (AzureWebJobs.*.Disabled) — handled in Step 3
    if ($key.Contains('.')) { return }
    $envVars[$key] = $val
}

# Helper: get value from env var override, then .env, then default
function Get-Val {
...
$FuncApp          = Get-Val "FUNC_FOUNDRY_APP"      "DEPLOY_FUNC_APP_NAME"
$FuncStorage      = Get-Val "FUNC_FOUNDRY_STORAGE"  "DEPLOY_FUNC_STORAGE_ACCOUNT"
...
Write-Host "=============================================="
Write-Host "AI Foundry Processing — Deployment Starting"
Write-Host "=============================================="
...
Write-Host ""
Write-Host "=============================================="
Write-Host "AI Foundry Processing — Deployment Complete"
Write-Host "=============================================="
Write-Host "  Function App: $FuncApp"
